                            ...
                            <div class="details">
                                ...
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input type="email" name="email" class="input-text" value="{{ old('email') }}" placeholder="Alamat Email">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn-md btn-theme btn-block shadow-blue">Masuk</button>
                                    </div>
                                </form>
                            </div>
                        </div>
